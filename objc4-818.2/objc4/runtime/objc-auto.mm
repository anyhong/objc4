...
BOOL objc_atomicCompareAndSwapPtr(id predicate, id replacement, volatile id *objectLocation) {
    void *original = InterlockedCompareExchangePointer((void *volatile *)objectLocation, (void *)replacement, (void *)predicate);
...
BOOL objc_is_finalized(void *ptr __unused) {
    return NO;
}
...
malloc_zone_t *objc_collect_init(int (*callback)() __unused) {
    return nil;
}
malloc_zone_t *objc_collectableZone() {
    return nil;
}

BOOL objc_isAuto(id object __unused) {
    return NO;
}
